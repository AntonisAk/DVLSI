...
#
# Generated by Vivado on Tue May 13 14:11:14 EEST 2025
...
#
# 1. This project restoration tcl script (fir_zybo1.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/antonis/Vivado/fir_zybo1/fir_zybo1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../Vivado/fir_zybo1/fir_zybo1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../Vivado/ip_repo/fir_ip_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/../../../Vivado/fir_zybo1"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../Vivado_Boards/vivado-boards/new/board_files"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../Vivado/ip_repo/fir_ip_1_0"]" $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../Vivado/fir_zybo1/fir_zybo1.gen/sources_1/bd/design_1/hdl/design_1_wrapper.vhd" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/fir_zybo1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
