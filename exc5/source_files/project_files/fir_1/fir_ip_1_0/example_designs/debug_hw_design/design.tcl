...
proc create_ipi_design { offsetfile design_name } {
	...
	set fir_ip_0 [ create_bd_cell -type ip -vlnv user.org:user:fir_ip:1.0 fir_ip_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:fir_ip:1.0]]]]
