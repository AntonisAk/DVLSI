...
#
# fir_zybo1.tcl: Tcl script for re-creating project 'fir_zybo1'
#
# Generated by Vivado on Wed May 14 12:35:57 EEST 2025
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/design_1_wrapper.dcp"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/fir_ip_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/fir_zybo1"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/fir_ip_1_0"]" $obj
...
set file "fir_1/design_1_wrapper.dcp"
...
\
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins fir_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins fir_ip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins fir_ip_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fir_ip_0/S00_AXI/S00_AXI_reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.992",
   "Default View_TopLeft":"-65,0",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 990 -y 250 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 990 -y 280 -defaultsOSRD
...
preplace inst fir_ip_0 -pg 1 -lvl 3 -x 870 -y 140 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 10 440 250 750J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 20 420
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 430 240 760
preplace netloc processing_system7_0_DDR 1 1 3 NJ 260 760J 250 NJ
...
levelinfo -pg 1 0 230 610 870 990
pagesize -pg 1 -db -bbox -sgen 0 0 1100 500
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/design_1_wrapper.vhd" ]
} else {
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/fir_zybo1.srcs/utils_1/imports/fir_1/design_1_wrapper.dcp" -objects $obj
