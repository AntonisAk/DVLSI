...
#
# Generated by Vivado on Wed May 14 13:32:19 EEST 2025
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/design_1_wrapper.dcp"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/fir_ip_3_0"]"]"\
  ]
  foreach ipath $paths {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/fir_ip_3_0"]" $obj
...
set file "fir_3/design_1_wrapper.dcp"
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/fir_zybo3.srcs/utils_1/imports/fir_3/design_1_wrapper.dcp" -objects $obj
